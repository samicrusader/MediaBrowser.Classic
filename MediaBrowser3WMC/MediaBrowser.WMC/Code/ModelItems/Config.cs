...
namespace MediaBrowser
{
    ...
    public class Config : IModelItem
    {
        ...
        {
            get { return this.CommonData.StartupParams; }
            set { if (this.CommonData.StartupParams != value) { this.CommonData.StartupParams = value; Save(); FireConfigPropertyChanged("StartupParams"); } }
        }
