...
namespace MediaBrowser.Library.Localization
{
    ...
    public class BaseStrings
    {
        ...
        public string AutomaticUpdatesConfigDesc = "Automatically check for updates to Jellyfin and plug-ins for Admin users";
        ...
        public string ShowClockConfigDesc = "Show the current time on all pages";
        ...
        public string ThemesConfigDesc = "Select the visual presentation style of Jellyfin";
        ...
        public string VisualThemeConfigDesc = "The basic presentation style for all pages";
        public string ColorSchemeConfigDesc = "The style of colors for backgrounds, etc. Won't take effect until the application is restarted.";
        public string FontSizeConfigDesc = "The size of the fonts to use. Won't take effect until the application is restarted.";
        ...
        public string StartDetailsPageinMiniModeConfigDesc = "Default media details page to mini-mode.";
        ...
        public string ClearCacheConfigDesc = "Delete the internal data files Jellyfin for WMC uses and re-build them";
        ...
        public string CheckForUpdateConfigDesc = "Check for updates to Jellyfin for WMC";
        ...
        public string PluginsConfigDesc = "Manage Jellyfin for WMC plug-ins";
        ...
        public string StartUpConfig = "Startup Behavior";
        ...
        public string EntryPointErrorDial = "Jellyfin could not launch.  Please be sure the server is running, awake and available on the network. ";
        public string EntryPointErrorCapDial = "Entrypoint Error";
        public string CriticalErrorDial = "Jellyfin for WMC encountered a critical error and had to shut down: ";
        ...
        public string RestartMBDial = "Please restart Jellyfin";
        ...
        public string UpdateMBDial = "Please visit {} to install the new version.";
        public string UpdateMBCapDial = "Update Available";
        public string UpdateMBExtDial = "There is an update available for Jellyfin for WMC.  Please update the next time you are at your MediaCenter PC.";
        public string DLUpdateFailDial = "Jellyfin will operate normally and prompt you again the next time you load it.";
        public string DLUpdateFailCapDial = "Update Download Failed";
        public string UpdateSuccessDial = "Jellyfin for WMC must now exit to apply the update.  It will restart automatically when it is done";
        ...
        public string ManualRefreshDial = "The server will scan your library. Changes will be reflected in Jellyfin for WMC when it is finished.";
        ...
        //Profiler
        public string WelcomeProf = "Welcome to Jellyfin for WMC";
